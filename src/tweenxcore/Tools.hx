...
class Easing {
     ...
     */
    /** 2-order */
    public static  inline function quadIn(t:Float):Float {//inline
        return t * t;
    }
    /** 2-order */
    public static  inline function quadOut(t:Float):Float {//inline
        return -t * (t - 2);
    }
    /** 2-order */
    public static  inline function quadInOut(t:Float):Float {//inline
